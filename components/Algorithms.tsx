...
import { clearBoard } from "../lib/utility";
...
export default function Algorithms() {
    ...
    const handleClearBoard = () => {
        ...
        dispatch<AController>(updateDataCountAction(0));
        dispatch<AController>(updateCentersCountAction(0));
