    ...
    return (
        <section className={algoStyles.algo_container}>
            <div className={algoStyles.wrapper} style={{ width : "80%" }}>
                ...
                <button className={selectedAlgo === Algos.Kmedoids ? "" : "inactive-btn"} onClick={() => Utility.handleAlgoChange(Algos.Kmedoids)} disabled={IsAppRunning} id={Algos.Kmeans}>K Medoids</button>
            </div>
