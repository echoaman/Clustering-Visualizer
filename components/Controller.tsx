        ...
        <section className={controllerStyles.controller}>
            <div className={controllerStyles.main_ctrl} >
                <div className={controllerStyles.main_ctrl_item}>
                    ...
                    <input className={controllerStyles.range} type="range" min="0" max={Settings.MaxDataLimit} value={DataCount} step="1" onChange={(e) => dataCountChange(parseInt(e.target.value))} />
                ...
                <div className={controllerStyles.main_ctrl_item}>
                    ...
                    <input className={controllerStyles.range} type="range" min="0" max={Settings.MaxCenterLimit} value={CentersCount} step="1" onChange={(e) => centerCountChange(parseInt(e.target.value))} />
