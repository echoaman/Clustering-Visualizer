...
import { clearBoard } from "../js/utility";
...
const Algorithms = () => {
    ...
    const handleClearBoard = () => {
        dispatch(Action_Update_Centroid_Count(0));
        dispatch(Action_Update_Centroids([]));
        dispatch(Action_Update_Data_Count(0));
        dispatch(Action_Update_Data([]));
        clearBoard();
    }
